...
g++ -std=c++20 win32_handmade.o handmade.o handmade_hero.cpp handmade_hero_platform.o -o win32_handmade -Iheaders -fmodules-ts -lgdi32 -ldsound -Wall -Wno-write-strings -Wno-unused-variable -DHANDMADE_INTERNAL -DHANDMADE_SLOW